...
| 2 | `constexpr` & `consteval` | **P5** | Thực thi compile-time evaluation dùng `IvyInterpret` trên tầng MIR |
...
| 7 | `constexpr` & `consteval` | ★★★ Khó | Đánh giá hằng số compile-time thông qua `IvyInterpret` v0.2 (MIR-based) |
